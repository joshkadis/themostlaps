...
module.exports = {
  ...
  describe: 'Make sure all activities have properly formatted activities',
  handler: async (args) => {
    if (!args.formatefforts) {
      console.warn("You didn't call `$ stats formatefforts`");
      return;
    }
     ...
     */
    await setupConnection(args, async ({
